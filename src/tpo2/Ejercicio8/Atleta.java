...
public class Atleta implements Runnable {
    ...
    public Atleta(Testigo recuTestigo, Long _tiempoInicioCarrera, int unTurno) {
    ...
    public void run() {
        ...
        try {
            ...
            while (!recuTestigo.esMiTurno(turno)){
                recuTestigo.largar();
            }
            ...
            float tiempoCarrera = (float) (Math.random() * (11000 - 9000 + 1) + 9000);  //codigo terapeutico anti ToC

            Thread.sleep((long) tiempoCarrera); // tiempo en hacer su carrera

            System.out
                    .println("El atleta " + Thread.currentThread().getName() + " termina de correr y entrega testigo");
            ...
            System.out.println(
                    "Tiempo " + Thread.currentThread().getName() + ": " + (long) tiempoCarrera / 1000 + " seg");
